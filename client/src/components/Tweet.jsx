            ...
            <div className="flex flex-col mx-3 w-full">
                ...
                {/* qouted tweet */}
                {
                    props.retweetedThis.length > 0 ? (
                        <div className="flex py-5 px-3 transition-all duration-200 border-[1px] border-stone-800 hover:bg-stone-400/5 rounded-2xl">
                            <div className="w-12">
                                <img className="h-10 w-10 rounded-full object-cover" src="https://res.cloudinary.com/dd8msdb9a/image/upload/v1712702220/Userimages/k3inrajwwhjzwvmcq1hd.jpg" alt="" />
                            </div>
                            <div className="flex flex-col ml-3 w-full">

                                <div className="flex flex-wrap gap-2 mb-3 ">
                                    <h3 className="font-medium hover:underline cursor-pointer">Elon Musk</h3>
                                    <BadgeCheck className="self-center text-black bg-yellow-500 rounded-full" size={16} />
                                    <span className="text-gray-500">@elon.musk</span>
                                    <span className="font-bold text-gray-500 mt-[-5px]">.</span>
                                    <span className="text-gray-500 self-center">1h</span>
                                </div>

                                <p className="mb-3 break-words text-wrap line-clamp-3 text-sm">
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Blanditiis inventore explicabo aliquam quos, vero voluptatem consectetur, dolorem distinctio!
                                </p>

                                <div className="pb-4 relative w-fit">
                                    <img className="rounded-md w-full object-cover" src="https://res.cloudinary.com/dd8msdb9a/image/upload/v1712702220/Userimages/k3inrajwwhjzwvmcq1hd.jpg" alt="" />
                                </div>
                ...
                <div className="flex justify-between mt-3 text-sm text-gray-600">
                    ...
                    <div className="flex items-center justify-center  hover:text-green-500 hover:cursor-pointer">
